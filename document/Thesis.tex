...
\title{Estrategia de Meta-Learning para Sistemas de AutoML Heterogéneos}
\author{\\\vspace{0.25cm}Roberto García Rodríguez}
\advisor{\\\vspace{0.25cm}Dr. Suilan Estevez Velarde}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{noviembre, 2002\\\vspace{0.25cm}\href{https://github.com/Robegr42/thesis}{github.com/Robegr42/thesis}}
